 ...
 */
static const char * const BAR_FONT = "-artwiz-cure-medium-r-normal-*-11-110-75-75-p-90-iso8859-1";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#170F0D";
static const char * const WIN_FS_COLOR = "#392925";
static const char * const SEL_COLOR    = "#AF652F";
static const char * const BAR_BG_COLOR = "#170F0D";
static const char * const BAR_FG_COLOR = "#746C48";
...
static const keymap_t keys[] = {
	...
	{ false,  XK_z,             it_toggle_bar,        (arg_t) None },
	...
	{ true,   XK_b,             it_shell_cmd,         (arg_t) \
			"hsetroot -fill \"$SXIV_IMG\"" },
	{ true,   XK_B,             it_shell_cmd,         (arg_t) \
			"hsetroot -tile \"$SXIV_IMG\"" },
};
